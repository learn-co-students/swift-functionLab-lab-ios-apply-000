...
func hey_cat(){
    let cat_name = "jester"
    let good_morning = "good morning :)"
    print("hey \(cat_name) \(good_morning)")
}
 ...
 */
// write your code here
func hello_person(person: String){
    let greeting = "welcome to playgrounds " + person + " i hope you enjoy your stay!"
    print(greeting)
}

hello_person(person: "James")
hello_person(person: "Dourthy")
hello_person(person: "Metilda")
...
// write your code here
func new_func(){
    var ice_cream_flavor:String = "vanilla"
    print("do you like \(ice_cream_flavor) flavored ice cream?")
    ice_cream_flavor = "strawberry"
    print("or maybe you like \(ice_cream_flavor) flavored ice cream?")
}
new_func()
new_func()
new_func()
