 ...
 */
func goodMorningYou(youName: String){
    print("Wake up \(youName) and make me breakfast! Please?")
}

goodMorningYou("Joshua")
goodMorningYou("Michael")
 ...
 */
var hurry = "eventually"

goodMorningYou(hurry)
 ...
 */
func fitness(pushUps: Int){
    print("This morning I knocked out \(pushUps) pushups before my coffee was brewed.")
}
