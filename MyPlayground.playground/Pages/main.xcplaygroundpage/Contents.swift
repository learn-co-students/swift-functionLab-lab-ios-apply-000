...
func greetings() {
    var name = "Andrew"
    print("Why hello there \(name), it is a pleasure to meet you!" )
}
greetings()
...
func yourName(name: String) {
    print("Why hello there \(name), it is very nice to meet you!")
}

yourName(name: "Bonnie")
yourName(name: "Emily")
yourName(name: "Andrew")
...
// write your code here
func randomFunc() {
    var brainFart = "Im having a hard time thinking of a variable that isn't pointless..."
    print(brainFart)
    brainFart = "Yup still having issues here... "
    print(brainFart)
}
