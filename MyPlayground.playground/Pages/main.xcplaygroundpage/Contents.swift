 ...
 */
func teachMeCode() {
    let teachMeCode = "Teach me code, please!"
    print(teachMeCode)
}
 ...
 */
func learnCode(coderName: String) {
    print("Hello, \(coderName), would you like to learn to code?")
}
 ...
 */
func pickAppCode() {
    var appCode = "Objective C"
    print ("I prefer to make iOS apps in \(appCode)")
    appCode = "Swift"
    print ("I prefer to make iOS apps in \(appCode)")
}
pickAppCode()
