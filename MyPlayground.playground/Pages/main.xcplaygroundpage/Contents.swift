...
func sayHiToFriends(name: String) {
    print("Hi, \(name)!")
}

sayHiToFriends(name: "Sean"
)

sayHiToFriends(name: "John")

sayHiToFriends(name: "Mark")

sayHiToFriends(name: "Jordan")
...
let friend = "Rich"
sayHiToFriends(name: friend)

var oldFriend = "Swartz"
sayHiToFriends(name: oldFriend)
...
func sayGoodbye() {
    var adios = "Goodbye, Sean"
    print (adios)
}

sayGoodbye()

var adios = "Goodbye, John"
