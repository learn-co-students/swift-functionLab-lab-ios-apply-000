 ...
 */
func hotlineBling() {
    let drake = "That can only mean one thing..."
    print(drake)
}
...
var lordOfTheSevenKingdoms = "Tommen Baratheon"
sayHello(lordOfTheSevenKingdoms)

// Spoiler alert!
lordOfTheSevenKingdoms = "Cersei Lannister"
sayHello(lordOfTheSevenKingdoms)
/*: question5
 ...
 */
func pVar() {
    var printMe = "This string is getting printed."
    print(printMe)
    printMe = "This string is getting printed too!"
    print(printMe)
}
