...
func printConstant(){
    let myConstant = "I'm having fun so far!"
    print(myConstant)
}
...
printGreeting(name: "Bill")
printGreeting(name: "Adam")
printGreeting(name: "Hana")
printGreeting(name: "Shelley")
printGreeting(name: "Peter")
...
let myBrother = "Adam"
let mySister = "Hana"
var myMother = "Shelley"
var myFather = "Peter"

printGreeting(name: me)
printGreeting(name: myBrother)
printGreeting(name: mySister)
printGreeting(name: myMother)
printGreeting(name: myFather)
