...
func greetSomeone(name:String){
    print("Howdy doo \(name)! Have a great day!")
}


greetSomeone("Jhantelle")
greetSomeone("Earl")
greetSomeone("LJ")
 ...
 */
// write your code here
func greetSomeone2(name:String){
    print("Howdy doo \(name)! Have a great day!")
}
...
// write your code here
func exercise(){
    var string = "Stringadingding!"
    print(string)
    
    string = "Changing the string!"
    print(string)
}
...
//Expect to see both strings being printed everytime the function is called
