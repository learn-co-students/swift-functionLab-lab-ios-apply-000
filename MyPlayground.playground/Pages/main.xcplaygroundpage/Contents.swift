 ...
 */
func helloWorldBurak(){

let bodyText = " Simple Hello World "
    print(bodyText)
...
PersonName(person: "Burak")

PersonName(person: "Burcu")

PersonName(person: "Nurten")

PersonName(person: "Jale")
 ...
 */
var callFuncText = " Burak "
PersonName(person: callFuncText)
 ...
 */
func PersonNameWithReturn(person: String) -> String
{
    
 let retval = " Hi, \(person)"
    return retval
    
}

var callval = "Burak"
print(PersonNameWithReturn(person: callval))
