 ...
 */
func myConstant() {
    let aConstant = ("Awesome home made constant")
    print(aConstant)
}
...
func welcomeMessage(name: String) {
    var greeting = "Welcome \(name), we hope you enjoy your stay!"
    print(greeting)
}

welcomeMessage(name: "Martin")

welcomeMessage(name: "Oliver")

welcomeMessage(name: "Ole")

welcomeMessage(name: "RandomDude")
 ...
 */
let name1 = "Froydis"
welcomeMessage(name1)

var name2 = "George"
welcomeMessage(name2)
name2 = "Marcia"
welcomeMessage(name2)
